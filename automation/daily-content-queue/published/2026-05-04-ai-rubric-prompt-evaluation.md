...
targetSlug: building-rubrics-for-ai-prompt-evaluation
publishOn: 2026-05-04
title: Building Rubrics for AI Prompt Evaluation
summary: AI prompt evaluation becomes more rigorous when students use rubrics that separate factuality, structure, usefulness, safety, and reproducibility.
...
1. Give all groups the same task.
2. Let each group write a prompt.
3. Generate outputs using the same model.
4. Score every output with the rubric.
5. Revise prompts based on the evidence.
6. Discuss which prompt changes improved which rubric dimensions.
