...
targetSlug: ism-service-catalogue-cleanup-sprint
title: Information System Service Catalogue Cleanup Sprint
description: A compact workshop plan for helping students improve a messy campus service catalogue with ownership, evidence, and lifecycle decisions.
publishOn: 2026-06-06
summary: An Information System Management activity for reviewing service catalogue quality and turning unclear entries into accountable service records.
...
1. **Ownership gap:** The person or team accountable for the service is unclear.
2. **Purpose gap:** The description does not explain who the service supports or what outcome it enables.
3. **Lifecycle gap:** The entry does not state whether the service is planned, active, under review, or retired.
4. **Dependency gap:** Important connected systems or data sources are missing.
5. **Evidence gap:** There is no usage, support, or performance evidence to guide decisions.
