...
targetSlug: ism-service-control-retrospective
title: Running a Service Control Retrospective for Campus Information Systems
description: A practical teaching article for reviewing whether information system controls actually helped a campus service after a release or incident.
publishOn: 2026-06-18
summary: An Information System Management lesson that turns post-release reflection into evidence about ownership, controls, user impact, and service improvement.
...
1. **Purpose:** What risk was each control meant to reduce?
2. **Evidence:** What logs, tickets, analytics, or user feedback show whether the control worked?
3. **Ownership:** Who noticed the signal, made the decision, and communicated the outcome?
4. **Friction:** Did the control slow down useful work without improving service quality?
5. **Improvement:** Should the control be kept, changed, automated, or retired?
